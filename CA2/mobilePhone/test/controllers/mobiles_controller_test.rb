...
class MobilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post mobiles_url, params: { mobile: { description: @mobile.description, model: @mobile.model, price: @mobile.price } }
    end
  ...
  test "should update mobile" do
    patch mobile_url(@mobile), params: { mobile: { description: @mobile.description, model: @mobile.model, price: @mobile.price } }
